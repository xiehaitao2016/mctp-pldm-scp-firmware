...
/*
 * Bit field definitions for System PIK registers.
 */

/* IOMACRO_OVERRIDE */
#define IOMACRO_OVERRIDE_TCU_L0GPTSZ_SHIFT (2)
#define IOMACRO_OVERRIDE_TCU_L0GPTSZ_MASK  (0xF)
#define IOMACRO_OVERRIDE_TCU_L0GPTSZ_16GB  (0x4)
