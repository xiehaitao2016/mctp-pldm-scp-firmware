...
struct mod_mhu3_channel_config scp2mcp_s_dbch_config[SCP2MCP_S_DBCH_COUNT] = {
    /* PBX CH 0, FLAG 0, MBX CH 0, FLAG 0 */
    MOD_MHU3_INIT_DBCH(0, 0, 0, 0),
};
