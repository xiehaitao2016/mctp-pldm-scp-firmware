...
/*!
 * \brief SCMI Pin Control Protocol
 */
#define MOD_SCMI_PROTOCOL_ID_PIN_CONTROL UINT32_C(0x19)

/*!
 * \brief SCMI Pin Control Protocol Message IDs
 */
enum scmi_pin_control_command_id {
    MOD_SCMI_PIN_CONTROL_ATTRIBUTES = 0x003,
    MOD_SCMI_PIN_CONTROL_LIST_ASSOCIATIONS = 0x004,
    MOD_SCMI_PIN_CONTROL_SETTINGS_GET = 0x005,
    MOD_SCMI_PIN_CONTROL_SETTINGS_CONFIGURE = 0x006,
    MOD_SCMI_PIN_CONTROL_REQUEST = 0x007,
    MOD_SCMI_PIN_CONTROL_RELEASE = 0x008,
    MOD_SCMI_PIN_CONTROL_NAME_GET = 0x009,
    MOD_SCMI_PIN_CONTROL_SET_PERMISSIONS = 0x00A,
