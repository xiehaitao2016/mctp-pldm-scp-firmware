...
struct system_pik_reg {
    ...
    FWK_RW  uint32_t  RSEPSI_STATUS;
    FWK_RW  uint32_t  RSESAM_STATUS0;
    FWK_RW  uint32_t  RSESAM_STATUS1;
    FWK_RW  uint32_t  RSELCM_STATUS;
...
/* Pointer to SCP System PIK register block */
