...
static const struct fwk_element service_table[MOD_SCMI_ELEMENT_COUNT] = {
    ...
    [SCP_CFGD_MOD_SCMI_RSS_POWER_DOWN_SEND] = {
        .name = "SERVICE_RSS_POWER_DOWN_SEND",
        .data = &((struct mod_scmi_service_config) {
            .transport_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_TRANSPORT,
            ...
            .transport_notification_init_id = FWK_ID_NOTIFICATION_INIT(
                FWK_MODULE_IDX_TRANSPORT,
                MOD_TRANSPORT_NOTIFICATION_IDX_INITIALIZED),
            .scmi_agent_id = SCP_SCMI_AGENT_IDX_RSS,
            .scmi_p2a_id = FWK_ID_NONE_INIT,
        }),
    },
    [SCP_CFGD_MOD_SCMI_MCP_POWER_DOWN_SEND] = {
        .name = "SERVICE_MCP_POWER_DOWN_SEND",
        .data = &((struct mod_scmi_service_config) {
            .transport_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_TRANSPORT,
    ...
    [SCP_CFGD_MOD_SCMI_RSS_POWER_DOWN_RECV] = {
        .name = "SERVICE_RSS_POWER_DOWN_RECV",
        .data = &((struct mod_scmi_service_config) {
            .transport_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_TRANSPORT,
    ...
    [SCP_CFGD_MOD_SCMI_MCP_POWER_DOWN_RECV] = {
        .name = "SERVICE_MCP_POWER_DOWN_RECV",
        .data = &((struct mod_scmi_service_config) {
            .transport_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_TRANSPORT,
