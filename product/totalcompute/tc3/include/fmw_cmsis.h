...
typedef enum IRQn {
    ...
    SCP_AP_MHU0_SEND_IRQ = 88, /* MHU0 SCP -> AP, SCP is Sender */
    AP_SCP_MHU0_REC_IRQ = 89, /* MHU0 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU1_SEND_IRQ = 90, /* MHU1 SCP -> AP, SCP is Sender */
    AP_SCP_MHU1_REC_IRQ = 91, /* MHU1 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU2_SEND_IRQ = 92, /* MHU2 SCP -> AP, SCP is Sender */
    AP_SCP_MHU2_REC_IRQ = 93, /* MHU2 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU3_SEND_IRQ = 94, /* MHU3 SCP -> AP, SCP is Sender */
    AP_SCP_MHU3_REC_IRQ = 95, /* MHU3 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU4_SEND_IRQ = 96, /* MHU4 SCP -> AP, SCP is Sender */
    AP_SCP_MHU4_REC_IRQ = 97, /* MHU4 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU5_SEND_IRQ = 98, /* MHU5 SCP -> AP, SCP is Sender */
    AP_SCP_MHU5_REC_IRQ = 99, /* MHU5 AP -> SCP, SCP is Receiver */
    SCP_AP_MHU6_SEND_IRQ = 100, /* MHU6 SCP -> AP, SCP is Sender */
    AP_SCP_MHU6_REC_IRQ = 101, /* MHU6 AP -> SCP, SCP is Receiver */
    SCP1_SCP0_MHU0_REC_IRQ = 102, /* MHU0 SCP1 -> SCP0, Remote SCP is Sender */
    ...
    SCP_RSS_MHU0_SEN_IRQ = 305, /* SCP RSS MHU0 Sender */
    RSS_SCP_MHU0_REC_IRQ = 306, /* RSS SCP MHU0 Receiver */
    ...
    /* RoS interrupts */
    DPU_IRQ0 = 377, /* DPU interrupt 0 */
    DPU_IRQ1 = 378, /* DPU interrupt 1 */
    VPU_IRQ = 379, /* VPU interrupt */

    DPU_TBU_PMU_IRQ = 385, /* DPU TBU PMU interrupt */
