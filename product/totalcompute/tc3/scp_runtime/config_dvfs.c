...
static const struct mod_dvfs_domain_config cpu_group_group_little = {
    .psu_id =
...
static const struct mod_dvfs_domain_config cpu_group_group_mid = {
    .psu_id =
...
static const struct mod_dvfs_domain_config cpu_group_group_big = {
    .psu_id =
