...
static const struct atu_region_map atu_regions[] = {
    {
        ...
        .log_addr_base = SCP_ATU_LOG_ADDR_GTCLK_AP,
        .phy_addr_base = SCP_ATU_PHY_ADDR_GTCLK_AP,
        .region_size = SCP_ATU_REG_SIZE_GTCLK_AP,
        .attributes = ATU_ENCODE_ATTRIBUTES_SECURE_PAS,
    },
    {
        .region_owner_id = FWK_ID_MODULE_INIT(FWK_MODULE_IDX_ATU),
        .log_addr_base = SCP_ATU_LOG_ADDR_GTCLK,
        .phy_addr_base = SCP_ATU_PHY_ADDR_GTCLK,
        .region_size = SCP_ATU_REG_SIZE_GTCLK,
        .attributes = ATU_ENCODE_ATTRIBUTES_SECURE_PAS,
    },
    {
        .region_owner_id = FWK_ID_MODULE_INIT(FWK_MODULE_IDX_ATU),
