...
static const struct fwk_element element_table[MOD_TRANSPORT_ELEMENT_COUNT]  = {
            ...
            struct mod_transport_channel_config) {
                ...
                .signal_api_id =
                    FWK_ID_API_INIT(
                        ...
                        MOD_SMCF_CLIENT_API_IDX_TRANSPORT_SIGNAL),
                .driver_id =
                    FWK_ID_SUB_ELEMENT_INIT(
                        FWK_MODULE_IDX_MHU3,
    ...
    [SCP_CFGD_MOD_TRANSPORT_EIDX_POWER_STATE_RSS_SEND] = {
        .name = "SCP_PLATFORM_TRANSPORT_POWER_STATE_RSS_SEND",
        .data = &((
            struct mod_transport_channel_config) {
                .transport_type = MOD_TRANSPORT_CHANNEL_TRANSPORT_TYPE_OUT_BAND,
                ...
                .out_band_mailbox_address =
                    (uintptr_t) SCP_RSS_TRANSPORT_PAYLOAD_BASE,
                .out_band_mailbox_size = SCP_RSS_TRANSPORT_PAYLOAD_SIZE,
                .signal_api_id =
                    FWK_ID_API_INIT(
                        FWK_MODULE_IDX_SCMI,
    ...
    [SCP_CFGD_MOD_TRANSPORT_EIDX_POWER_STATE_RSS_RECV] = {
        .name = "SCP_PLATFORM_TRANSPORT_POWER_STATE_RSS_RECV",
        .data = &((
            struct mod_transport_channel_config) {
                .transport_type = MOD_TRANSPORT_CHANNEL_TRANSPORT_TYPE_OUT_BAND,
                .policies = MOD_TRANSPORT_POLICY_INIT_MAILBOX |
    ...
    [SCP_CFGD_MOD_TRANSPORT_EIDX_POWER_STATE_MCP_SEND] = {
        .name = "SCP_PLATFORM_TRANSPORT_SHUTDOWN_MCP",
        .data = &((
            struct mod_transport_channel_config) {
                .transport_type = MOD_TRANSPORT_CHANNEL_TRANSPORT_TYPE_OUT_BAND,
                .policies = MOD_TRANSPORT_POLICY_INIT_MAILBOX |
                ...
                .channel_type = MOD_TRANSPORT_CHANNEL_TYPE_REQUESTER,
                .out_band_mailbox_address =
                    (uintptr_t) SCP_MCP_TRANSPORT_PAYLOAD_BASE,
                .out_band_mailbox_size = SCP_MCP_TRANSPORT_PAYLOAD_SIZE,
                .signal_api_id =
                    FWK_ID_API_INIT(
                        FWK_MODULE_IDX_SCMI,
                        MOD_SCMI_API_IDX_TRANSPORT),
    ...
    [SCP_CFGD_MOD_TRANSPORT_EIDX_POWER_STATE_MCP_RECV] = {
        .name = "SCP_PLATFORM_TRANSPORT_POWER_STATE_MCP_RECV",
        .data = &((
            struct mod_transport_channel_config) {
                .transport_type = MOD_TRANSPORT_CHANNEL_TRANSPORT_TYPE_OUT_BAND,
                .policies = MOD_TRANSPORT_POLICY_INIT_MAILBOX |
