...
static const ARM_MPU_Region_t regions[] = {
    ...
    {
        /*
         * SCP_AP_PERIPHERAL_SRAM_TRUSTED_BASE is mapped to 0x0000_0000 -
         * 0x0000_1FFF in AP memory map.
         */
    ...
    {
        /*
         * SCP_AP_PERIPHERAL_SRAM_NONTRUSTED_BASE is mapped to 0x0000_2000 -
         * 0x0000_3000 in AP memory map.
         */
