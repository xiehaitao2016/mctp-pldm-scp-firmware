 ...
 */
static const struct fwk_element *tc_power_domain_get_element_table(
    fwk_id_t module_id)
{
    return create_power_domain_element_table(
        ...
        tc_power_domain_static_element_table,
        FWK_ARRAY_SIZE(tc_power_domain_static_element_table));
}
...
const struct fwk_module_config config_power_domain = {
    .elements = FWK_MODULE_DYNAMIC_ELEMENTS(tc_power_domain_get_element_table),
    .data = &tc_power_domain_config,
};
